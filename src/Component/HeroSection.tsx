      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-16 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-14">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <div className="mt-6 sm:mt-8 flex flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4">
            ...
            <button
              className="brand-gradient-bg flex-1 sm:flex-initial px-4 sm:px-7 py-3 rounded-xl font-semibold text-xs sm:text-sm md:text-base text-white hover:opacity-95 transition-opacity shadow-sm cursor-pointer border-none whitespace-nowrap"
            >
            ...
            {/* Learn More Button */}
            <button
              className="flex-1 sm:flex-initial px-4 sm:px-7 py-3 rounded-xl font-medium text-xs sm:text-sm md:text-base text-slate-600 bg-white border border-slate-200 hover:bg-slate-50 transition-colors cursor-pointer whitespace-nowrap"
            >
              Learn More
            </button>
